...
1. 根据用户上传图片的坐标信息将图片展示在地图上，并添加聚类显示效果、添加点击事件
 ...
 <div align=center><img width=750px  src="https://github.com/NorthwesternDirector/plantCamera-Project/blob/master/captures/captures%20(7).png"></div>
 <div align=center><img width=750px  src="https://github.com/NorthwesternDirector/plantCamera-Project/blob/master/captures/captures%20(2).png"></div><br>
...
<div align=center><img width=750px  src="https://github.com/NorthwesternDirector/plantCamera-Project/blob/master/captures/captures%20(1).png"></div><br>
